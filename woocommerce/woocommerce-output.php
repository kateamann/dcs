...
add_action( 'wp_enqueue_scripts', 'dcs_woocommerce_css' );
/**
...
function dcs_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'dcs_link_color', dcs_customizer_get_default_link_color() );
	$color_accent = get_theme_mod( 'dcs_accent_color', dcs_customizer_get_default_accent_color() );

	$woo_css = '';

	$woo_css .= ( dcs_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$woo_css .= ( dcs_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
	...
	',
		$color_accent,
		dcs_color_contrast( $color_accent )
	) : '';

	if ( $woo_css ) {
		wp_add_inline_style( 'dcs-woocommerce-styles', $woo_css );
	}
